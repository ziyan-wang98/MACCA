...
class TD3Agent(object):
    ...
    def __init__(
        ...
        self.policy = MLPNetwork(num_in_pol, num_out_pol, hidden_dim=hidden_dim, constrain_out=True, discrete_action=discrete_action, policy_ln=policy_ln)
        self.target_policy = MLPNetwork(num_in_pol, num_out_pol, hidden_dim=hidden_dim, constrain_out=True, discrete_action=discrete_action, policy_ln=policy_ln)

        self.critic = DoubleMLPNetwork(num_in_critic, num_out_critic, hidden_dim=hidden_dim, constrain_out=False, critic_ln=critic_ln)
        self.target_critic = DoubleMLPNetwork(num_in_critic, num_out_critic, hidden_dim=hidden_dim, constrain_out=False, critic_ln=critic_ln)
