...
class ReplayBuffer(object):
    ...
    def load_batch_data(self, dir):
        ...
        for i in range(self.num_agents):
            curr_obs = np.load(dir + '/' + 'obs_{}.npy'.format(i), allow_pickle=True)
            curr_acs = np.load(dir + '/' + 'acs_{}.npy'.format(i), allow_pickle=True)
            curr_rews = np.load(dir + '/' + 'rews_{}.npy'.format(i), allow_pickle=True)
            curr_next_obs = np.load(dir + '/' + 'next_obs_{}.npy'.format(i), allow_pickle=True)
            curr_dones = np.load(dir + '/' + 'dones_{}.npy'.format(i), allow_pickle=True)
            ...
            if self.is_mamujoco:
                curr_states = np.load(dir + '/' + 'states_{}.npy'.format(i), allow_pickle=True)
                curr_next_states = np.load(dir + '/' + 'next_states_{}.npy'.format(i), allow_pickle=True)
