...
# This super-hard map needs ~10M env steps; reported = best win-rate over eval checkpoints. seed=1 pins the run.
...
xvfb-run -a -s "-screen 0 1024x768x24" python3 src/main.py \
  ...
  with env_args.map_name=6h_vs_8z h5file_suffix=expert t_max=10050000 use_offline=True seed=1
