...
class SQDDPGLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        # Compute backward operations for both losses
        (self.args.shapley_loss * shapley_loss).backward(retain_graph=True)  # Retain graph for the next backward pass
        (self.args.actor_loss * actor_loss - self.args.logit_entropy * logit_entropy).backward()

        # Clipping gradients and updating parameters for the mixer
        ...
        # Clipping gradients and updating parameters for the mac
